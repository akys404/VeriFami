...
def decoder(i_decoder):
    ...
    if r_res == True:
        if r_stage == stage_e.T1:
            ...
            ctrl_signals = ctrl_t(o_rw=1, sel_abh=7, sel_abl=8)
        elif r_stage == stage_e.T3:
            ctrl_signals = ctrl_t(o_rw=1, sel_st=1, sel_sub=1, sel_ain=0, sel_bin=2, sel_abh=7, sel_abl=9)
    ...
    # NMI
        ...
        if r_stage == stage_e.T1:
            ...
            ctrl_signals = ctrl_t(o_rw=0, sel_b=0, sel_main=8, sel_sub=0, sel_ain=1, sel_bin=2, sel_cin=0, sel_alu=0, sel_abh=6, sel_abl=2)
        elif r_stage == stage_e.T5:
            ctrl_signals = ctrl_t(o_rw=0, sel_main=0, en_sp=1, sel_cin=0, sel_alu=0, sel_abh=7, sel_abl=6)
        elif r_stage == stage_e.T6:
            ctrl_signals = ctrl_t(o_rw=1, sel_st=1, en_p=0x04, sel_p=1, sel_sub=1, sel_ain=0, sel_bin=2, sel_abh=7, sel_abl=7)
        elif r_stage == stage_e.T0:
            ctrl_signals = ctrl_t(o_rw=1, sel_st=2, sel_cin=0, sel_alu=0, sel_abh=3, sel_abl=2, sel_pch=3, sel_pcl=2)
    ...
    # IRQ
        ...
        if r_stage == stage_e.T1:
            ...
            ctrl_signals = ctrl_t(o_rw=1, sel_st=1, en_p=0x04, sel_p=1, sel_sub=1, sel_ain=0, sel_bin=2, sel_abh=7, sel_abl=0xB)
        elif r_stage == stage_e.T0:
            ctrl_signals = ctrl_t(o_rw=1, sel_st=2, sel_cin=0, sel_alu=0, sel_abh=3, sel_abl=2, sel_pch=3, sel_pcl=2)
