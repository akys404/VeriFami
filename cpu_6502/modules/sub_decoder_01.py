...
def sub_decoder_01(r_ir, r_stage):
    ...
    if r_ir == 0x40:
        if r_stage == stage_e.T1:
            ...
            ctrl_signals = ctrl_t(sel_rw=1, sel_sub=0, sel_ain=0, sel_bin=2, sel_cin=1, sel_alu=0, sel_abh=6, sel_abl=2)
        elif r_stage == stage_e.T4:
            ctrl_signals = ctrl_t(sel_rw=1, en_p=0xFF, sel_p=3, sel_sub=0, sel_ain=0, sel_bin=2, sel_cin=1, sel_alu=0, sel_abh=6, sel_abl=2)
        elif r_stage == stage_e.T5:
            ctrl_signals = ctrl_t(sel_rw=1, sel_st=1, sel_main=0, sel_sub=1, en_sp=1, sel_ain=0, sel_bin=2, sel_cin=1, sel_alu=0, sel_abh=6, sel_abl=2)
    ...
    # EOR-(IND,X)
        ...
        if r_stage == stage_e.T1:
            ctrl_signals = ctrl_t(sel_rw=1, en_ir=1, en_p=0x82, sel_p=2, sel_main=0, en_a=1, sel_cin=0, sel_alu=4, sel_abh=1, sel_abl=1, sel_pch=1, sel_pcl=1)
        elif r_stage == stage_e.T2:
    ...
    # LSR-ZEROPAGE
        ...
        if r_stage == stage_e.T1:
            ...
            ctrl_signals = ctrl_t(sel_rw=0, sel_st=1, en_p=0x83, sel_p=2, sel_main=0, sel_cin=0, sel_alu=6)
        elif r_stage == stage_e.T0:
    ...
    # PHA-IMPLIED
        ...
        if r_stage == stage_e.T1:
            ...
            ctrl_signals = ctrl_t(sel_rw=0, sel_st=1, sel_main=4, sel_sub=3, sel_ain=1, sel_bin=2, sel_abh=6, sel_abl=5)
        elif r_stage == stage_e.T0:
    ...
    # LSR-ACCUM
        ...
        if r_stage == stage_e.T1:
            ctrl_signals = ctrl_t(sel_rw=1, en_ir=1, en_p=0x83, sel_p=2, sel_main=0, en_a=1, sel_cin=0, sel_alu=6, sel_abh=1, sel_abl=1, sel_pch=1, sel_pcl=1)
        elif r_stage == stage_e.T2:
    ...
    # JMP-ABSOLUTE
        ...
        if r_stage == stage_e.T1:
            ...
            ctrl_signals = ctrl_t(sel_rw=1, sel_st=1, sel_sub=1, sel_ain=0, sel_bin=2, sel_abh=1, sel_abl=1, sel_pch=1, sel_pcl=1)
        elif r_stage == stage_e.T0:
            ctrl_signals = ctrl_t(sel_rw=1, sel_st=2, sel_cin=0, sel_alu=0, sel_abh=3, sel_abl=2, sel_pch=3, sel_pcl=2)
    ...
    # BVC-RELATIVE
        ...
        if r_stage == stage_e.T1:
            ...
            ctrl_signals = ctrl_t(sel_rw=1, sel_st=7, sel_main=1, sel_sub=2, sel_ain=2, sel_bin=2, sel_abh=1, sel_abl=1, sel_pch=1, sel_pcl=1)
        elif r_stage == stage_e.T3:
    ...
    # EOR-ZPG,X
        ...
        if r_stage == stage_e.T1:
            ...
            ctrl_signals = ctrl_t(sel_rw=1, sel_st=1, sel_cin=1, sel_alu=0, sel_abh=5, sel_abl=2)
        elif r_stage == stage_e.T0:
            ctrl_signals = ctrl_t(sel_rw=1, sel_st=2, sel_main=4, sel_sub=1, sel_ain=2, sel_bin=2, sel_abh=4, sel_abl=4)
    ...
    # CLI-IMPLIED
        ...
        if r_stage == stage_e.T1:
            ...
            ctrl_signals = ctrl_t(sel_rw=1, sel_st=2, en_p=0x04, sel_p=0, sel_abh=4, sel_abl=4)
    ...
    # RTS-IMPLIED
        ...
        if r_stage == stage_e.T1:
            ...
            ctrl_signals = ctrl_t(sel_rw=1, sel_main=0, sel_sub=1, en_sp=1, sel_ain=0, sel_bin=2, sel_cin=1, sel_alu=0, sel_abh=6, sel_abl=2)
        elif r_stage == stage_e.T5:
            ctrl_signals = ctrl_t(sel_rw=1, sel_st=1, sel_cin=0, sel_alu=0, sel_abh=3, sel_abl=2, sel_pch=3, sel_pcl=2)
        elif r_stage == stage_e.T0:
            ctrl_signals = ctrl_t(sel_rw=1, sel_st=2, sel_abh=1, sel_abl=1, sel_pch=1, sel_pcl=1)

    # ADC-(IND,X)
    elif r_ir == 0x61:
        if r_stage == stage_e.T1:
            ctrl_signals = ctrl_t(sel_rw=1, en_ir=1, en_p=0xC3, sel_p=2, sel_main=0, en_a=1, sel_cin=2, sel_alu=0, sel_abh=1, sel_abl=1, sel_pch=1, sel_pcl=1)
        elif r_stage == stage_e.T2:
            ctrl_signals = ctrl_t(sel_rw=1, sel_main=2, sel_sub=1, sel_ain=2, sel_bin=2, sel_pch=1, sel_pcl=1)
        elif r_stage == stage_e.T3:
            ctrl_signals = ctrl_t(sel_rw=1, sel_sub=0, sel_ain=0, sel_bin=2, sel_cin=0, sel_alu=0, sel_abh=5, sel_abl=2)
    ...
    # ROR-ZEROPAGE
        ...
        if r_stage == stage_e.T1:
            ...
            ctrl_signals = ctrl_t(sel_rw=0, sel_st=1, en_p=0x83, sel_p=2, sel_main=0, sel_cin=2, sel_alu=8)
        elif r_stage == stage_e.T0:
            ctrl_signals = ctrl_t(sel_rw=1, sel_st=2, sel_abh=4, sel_abl=4)
    ...
    # ROR-ACCUM
        ...
        if r_stage == stage_e.T1:
            ctrl_signals = ctrl_t(sel_rw=1, en_ir=1, en_p=0x83, sel_p=2, sel_main=0, en_a=1, sel_cin=2, sel_alu=8, sel_abh=1, sel_abl=1, sel_pch=1, sel_pcl=1)
        elif r_stage == stage_e.T2:
            ctrl_signals = ctrl_t(sel_rw=1, sel_st=2, sel_main=4, sel_ain=2, sel_bin=0, sel_abh=4, sel_abl=4)
    ...
    # JMP-INDIRECT
        ...
        if r_stage == stage_e.T1:
            ...
            ctrl_signals = ctrl_t(sel_rw=1, sel_sub=0, sel_ain=0, sel_bin=2, sel_cin=0, sel_alu=0, sel_abh=3, sel_abl=2)
        elif r_stage == stage_e.T4:
            ctrl_signals = ctrl_t(sel_rw=1, sel_st=1, sel_sub=1, sel_ain=0, sel_bin=2, sel_cin=1, sel_alu=0, sel_abl=2)
        elif r_stage == stage_e.T0:
            ctrl_signals = ctrl_t(sel_rw=1, sel_st=2, sel_cin=0, sel_alu=0, sel_abh=3, sel_abl=2, sel_pch=3, sel_pcl=2)
    ...
    # BVS-RELATIVE
        ...
        if r_stage == stage_e.T1:
            ...
            ctrl_signals = ctrl_t(sel_rw=1, sel_st=8, sel_main=1, sel_sub=2, sel_ain=2, sel_bin=2, sel_abh=1, sel_abl=1, sel_pch=1, sel_pcl=1)
        elif r_stage == stage_e.T3:
            ctrl_signals = ctrl_t(sel_rw=1, sel_st=4, sel_main=6, sel_ain=2, sel_bin=3, sel_cin=0, sel_alu=0, sel_abl=2)
        elif r_stage == stage_e.T0:
            ctrl_signals = ctrl_t(sel_rw=1, sel_st=2, sel_cin=3, sel_alu=0, sel_abh=2)
    ...
    # SEI-IMPLIED
        ...
        if r_stage == stage_e.T1:
            ...
            ctrl_signals = ctrl_t(sel_rw=1, sel_st=2, en_p=0x04, sel_p=1, sel_abh=4, sel_abl=4)
